...
public class TinyDB {
    ...
    public ArrayList<Plat> getListObject(String key){
        Gson gson = new Gson();
        ArrayList<String> objStrings = getListString(key);
        ArrayList<Plat> playerList =  new ArrayList<Plat>();
        for(String jObjString : objStrings){
            Plat player  = gson.fromJson(jObjString,  Plat.class);
    ...
    public void putListObject(String key, ArrayList<Plat> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
